...
func (c *version) NetworkAttachmentDefinition() NetworkAttachmentDefinitionController {
	return NewNetworkAttachmentDefinitionController(schema.GroupVersionKind{Group: "k8s.cni.cncf.io", Version: "v1", Kind: "NetworkAttachmentDefinition"}, "networkattachmentdefinitions", true, c.controllerFactory)
}
