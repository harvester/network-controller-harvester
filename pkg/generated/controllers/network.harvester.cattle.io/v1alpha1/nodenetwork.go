...
type NodeNetworkHandler func(string, *v1alpha1.NodeNetwork) (*v1alpha1.NodeNetwork, error)
...
type NodeNetworkClient interface {
	Create(*v1alpha1.NodeNetwork) (*v1alpha1.NodeNetwork, error)
	Update(*v1alpha1.NodeNetwork) (*v1alpha1.NodeNetwork, error)
	UpdateStatus(*v1alpha1.NodeNetwork) (*v1alpha1.NodeNetwork, error)
	Delete(namespace, name string, options *metav1.DeleteOptions) error
	Get(namespace, name string, options metav1.GetOptions) (*v1alpha1.NodeNetwork, error)
	List(namespace string, opts metav1.ListOptions) (*v1alpha1.NodeNetworkList, error)
	Watch(namespace string, opts metav1.ListOptions) (watch.Interface, error)
	Patch(namespace, name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.NodeNetwork, err error)
}

type NodeNetworkCache interface {
	Get(namespace, name string) (*v1alpha1.NodeNetwork, error)
	List(namespace string, selector labels.Selector) ([]*v1alpha1.NodeNetwork, error)

	AddIndexer(indexName string, indexer NodeNetworkIndexer)
	GetByIndex(indexName, key string) ([]*v1alpha1.NodeNetwork, error)
}

type NodeNetworkIndexer func(obj *v1alpha1.NodeNetwork) ([]string, error)
...
func FromNodeNetworkHandlerToHandler(sync NodeNetworkHandler) generic.Handler {
	return func(key string, obj runtime.Object) (ret runtime.Object, err error) {
		var v *v1alpha1.NodeNetwork
		if obj == nil {
			v, err = sync(key, nil)
		} else {
			v, err = sync(key, obj.(*v1alpha1.NodeNetwork))
		}
		if v == nil {
			return nil, err
		}
...
func (c *nodeNetworkController) Updater() generic.Updater {
	return func(obj runtime.Object) (runtime.Object, error) {
		newObj, err := c.Update(obj.(*v1alpha1.NodeNetwork))
		if newObj == nil {
			return nil, err
		}
		return newObj, err
...
func UpdateNodeNetworkDeepCopyOnChange(client NodeNetworkClient, obj *v1alpha1.NodeNetwork, handler func(obj *v1alpha1.NodeNetwork) (*v1alpha1.NodeNetwork, error)) (*v1alpha1.NodeNetwork, error) {
	if obj == nil {
		return obj, nil
	}
...
func (c *nodeNetworkController) Create(obj *v1alpha1.NodeNetwork) (*v1alpha1.NodeNetwork, error) {
	result := &v1alpha1.NodeNetwork{}
	return result, c.client.Create(context.TODO(), obj.Namespace, obj, result, metav1.CreateOptions{})
}

func (c *nodeNetworkController) Update(obj *v1alpha1.NodeNetwork) (*v1alpha1.NodeNetwork, error) {
	result := &v1alpha1.NodeNetwork{}
	return result, c.client.Update(context.TODO(), obj.Namespace, obj, result, metav1.UpdateOptions{})
}

func (c *nodeNetworkController) UpdateStatus(obj *v1alpha1.NodeNetwork) (*v1alpha1.NodeNetwork, error) {
	result := &v1alpha1.NodeNetwork{}
...
func (c *nodeNetworkController) Get(namespace, name string, options metav1.GetOptions) (*v1alpha1.NodeNetwork, error) {
	result := &v1alpha1.NodeNetwork{}
	return result, c.client.Get(context.TODO(), namespace, name, result, options)
}

func (c *nodeNetworkController) List(namespace string, opts metav1.ListOptions) (*v1alpha1.NodeNetworkList, error) {
	result := &v1alpha1.NodeNetworkList{}
...
func (c *nodeNetworkController) Patch(namespace, name string, pt types.PatchType, data []byte, subresources ...string) (*v1alpha1.NodeNetwork, error) {
	result := &v1alpha1.NodeNetwork{}
...
func (c *nodeNetworkCache) Get(namespace, name string) (*v1alpha1.NodeNetwork, error) {
	...
	return obj.(*v1alpha1.NodeNetwork), nil
}

func (c *nodeNetworkCache) List(namespace string, selector labels.Selector) (ret []*v1alpha1.NodeNetwork, err error) {

	err = cache.ListAllByNamespace(c.indexer, namespace, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.NodeNetwork))
	})
...
func (c *nodeNetworkCache) AddIndexer(indexName string, indexer NodeNetworkIndexer) {
	utilruntime.Must(c.indexer.AddIndexers(map[string]cache.IndexFunc{
		indexName: func(obj interface{}) (strings []string, e error) {
			return indexer(obj.(*v1alpha1.NodeNetwork))
		},
	}))
}

func (c *nodeNetworkCache) GetByIndex(indexName, key string) (result []*v1alpha1.NodeNetwork, err error) {
	objs, err := c.indexer.ByIndex(indexName, key)
	if err != nil {
		return nil, err
	}
	result = make([]*v1alpha1.NodeNetwork, 0, len(objs))
	for _, obj := range objs {
		result = append(result, obj.(*v1alpha1.NodeNetwork))
	}
	return result, nil
}

type NodeNetworkStatusHandler func(obj *v1alpha1.NodeNetwork, status v1alpha1.NodeNetworkStatus) (v1alpha1.NodeNetworkStatus, error)

type NodeNetworkGeneratingHandler func(obj *v1alpha1.NodeNetwork, status v1alpha1.NodeNetworkStatus) ([]runtime.Object, v1alpha1.NodeNetworkStatus, error)
...
func (a *nodeNetworkStatusHandler) sync(key string, obj *v1alpha1.NodeNetwork) (*v1alpha1.NodeNetwork, error) {
	if obj == nil {
		return obj, nil
	}
...
func (a *nodeNetworkGeneratingHandler) Remove(key string, obj *v1alpha1.NodeNetwork) (*v1alpha1.NodeNetwork, error) {
	if obj != nil {
		return obj, nil
	}

	obj = &v1alpha1.NodeNetwork{}
...
func (a *nodeNetworkGeneratingHandler) Handle(obj *v1alpha1.NodeNetwork, status v1alpha1.NodeNetworkStatus) (v1alpha1.NodeNetworkStatus, error) {
