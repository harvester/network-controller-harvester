...
func newClusterNetworks(c *NetworkV1alpha1Client, namespace string) *clusterNetworks {
...
func (c *clusterNetworks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ClusterNetwork, err error) {
...
func (c *clusterNetworks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ClusterNetworkList, err error) {
...
func (c *clusterNetworks) Create(ctx context.Context, clusterNetwork *v1alpha1.ClusterNetwork, opts v1.CreateOptions) (result *v1alpha1.ClusterNetwork, err error) {
	result = &v1alpha1.ClusterNetwork{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("clusternetworks").
...
func (c *clusterNetworks) Update(ctx context.Context, clusterNetwork *v1alpha1.ClusterNetwork, opts v1.UpdateOptions) (result *v1alpha1.ClusterNetwork, err error) {
	result = &v1alpha1.ClusterNetwork{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("clusternetworks").
...
func (c *clusterNetworks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ClusterNetwork, err error) {
	result = &v1alpha1.ClusterNetwork{}
