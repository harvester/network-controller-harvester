...
import (
	typedv1 "github.com/harvester/harvester-network-controller/pkg/generated/clientset/versioned/typed/v1"
...
func newFakeServices(fake *FakeCoreV1, namespace string) typedv1.ServiceInterface {
	return &fakeServices{
