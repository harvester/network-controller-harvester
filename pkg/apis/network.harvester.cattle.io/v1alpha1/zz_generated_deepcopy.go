...
func (in *HostNetworkStatus) DeepCopyInto(out *HostNetworkStatus) {
	*out = *in
	...
	if in.PhysicalNics != nil {
		in, out := &in.PhysicalNics, &out.PhysicalNics
		*out = make([]PhysicalNic, len(*in))
		copy(*out, *in)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PhysicalNic) DeepCopyInto(out *PhysicalNic) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PhysicalNic.
func (in *PhysicalNic) DeepCopy() *PhysicalNic {
	if in == nil {
		return nil
	}
	out := new(PhysicalNic)
