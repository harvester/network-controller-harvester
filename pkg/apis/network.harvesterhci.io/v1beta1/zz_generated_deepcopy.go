...
func (in *LinkMonitorStatus) DeepCopyInto(out *LinkMonitorStatus) {
	*out = *in
	...
	if in.LinkStatus != nil {
		...
		*out = make(map[string]LinkStatusList, len(*in))
		for key, val := range *in {
			...
			if val == nil {
				...
				in, out := &val, &outVal
				*out = make(LinkStatusList, len(*in))
				copy(*out, *in)
			}
			(*out)[key] = outVal
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in LinkStatusList) DeepCopyInto(out *LinkStatusList) {
	{
		in := &in
		*out = make(LinkStatusList, len(*in))
		copy(*out, *in)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LinkStatusList.
func (in LinkStatusList) DeepCopy() LinkStatusList {
	if in == nil {
		return nil
	}
	out := new(LinkStatusList)
	in.DeepCopyInto(out)
	return *out
}
