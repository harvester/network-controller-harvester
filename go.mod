...
replace (
	...
	k8s.io/kube-openapi v0.0.0-20260623045532-0b43c5e46c6b k8s.io/kube-openapi v0.0.0-20250318190949-c8a335a9a2ff // indirect
...
require (
	...
	github.com/rancher/dynamiclistener v0.8.2 // indirect
